#if UNITY_2018_4 || UNITY_2019_4 ||  UNITY_2020_3_OR_NEWER
...
namespace HomaGames.HomaBelly
{
    ...
    internal class AnalyticsHelper
    {
        ...
        private void OnHomaBellyInitialized()
        {
            ...
            // Track network reachability and start listening to changes
            TrackNetworkReachability(Application.internetReachability);
        ...
        public void OnApplicationPause(bool pause)
        {
            ...
            else
            {
                ...
                // Save last resume timestamp
                PlayerPrefs.SetString(LAST_APPLICATION_RESUME_TIMESTAMP_KEY, GetUtcNowInSeconds());
                PlayerPrefs.Save();
            }
        }

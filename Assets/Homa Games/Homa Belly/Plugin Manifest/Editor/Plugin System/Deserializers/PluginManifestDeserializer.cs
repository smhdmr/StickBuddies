...
namespace HomaGames.HomaBelly
{
    ...
    {
        private static string LOCAL_PLUGIN_MANIFEST_FILE = Application.dataPath + "/Homa Games/Homa Belly/Plugin Manifest/Editor/Plugin System/PluginManifest.json";
        ...
        public PluginManifest LoadFromCache()
        {
            try
            {
                ...
                {
                    string manifestJson = FileUtilities.ReadAllText(LOCAL_PLUGIN_MANIFEST_FILE);
        ...
        private void CacheSerialization(string pluginManifestJson)
        {
            try
            {
                FileUtilities.CreateIntermediateDirectoriesIfNecessary(LOCAL_PLUGIN_MANIFEST_FILE);
